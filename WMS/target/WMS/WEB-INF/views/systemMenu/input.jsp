	...
	<div id="container">
		...
		<div class="ui_content">
			<table cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<s:hidden name="systemMenu.parentMenu.id" value="%{query.parentId}"/>
				<tr>
					<td class="ui_text_rt" width="140">上级菜单</td>
					<td class="ui_text_lt">
						<s:textfield name="systemMenu.parentMenu.name" value="%{parentName}" class="ui_input_txt02" readonly="true"/>
					</td>
				</tr>
				<tr>
