			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_center">
							姓名/邮箱
							<s:textfield class="ui_input_txt02" name="query.keyword"/>
							所属部门
							<s:select list="#departments" name="query.departId" listKey="id" listValue="name"
									  headerKey="-1" headerValue="全部"/>
						</div>
						<div id="box_bottom">
							<input type="button" value="查询" class="ui_input_btn01 page_btn"/>
							<input type="button" value="新增" class="ui_input_btn01 btn_href" data-url="<s:url namespace="/" action="employee_input"/>"/>
							<input type="button" value="删除" class="ui_input_btn01 batch_delete_btn" data-url="<s:url namespace="/" action="employee_batchDelete"/>"/>
						</div>
					</div>
				</div>
			</div>
						...
						<tbody>
							...
							<s:iterator value="#pageResult.dataResults">
								<tr>
									...
									<td><s:property value="depart.name"/></td>
									<td><s:property value="allRoleName"/></td>
									<td>
