			...
			<div class="ui_content">
				<div class="ui_text_indent">
					<div id="box_border">
						...
						<div id="box_bottom">
							<input type="button" value="新增" class="ui_input_btn01 btn_href" data-url="<s:url namespace="/" action="department_input"/>"/>
							<input type="button" value="删除" class="ui_input_btn01 batch_delete_btn" data-url="<s:url namespace="/" action="department_batchDelete"/>"/>
						</div>
					</div>
				</div>
			</div>
